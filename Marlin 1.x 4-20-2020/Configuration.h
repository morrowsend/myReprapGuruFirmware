...
/*  I autotuned for these values:
 *   /*
   * Run M503 to get a rad of all the current PID values of the machine.
   * it will give you two values, one for hot-end and one for bed:
   * 12:33:41.303 : echo:PID settings:
   * 12:33:41.305 : echo:  M301 P22.20 I1.08 D114.00  <-- extruder
   * 12:33:41.305 : echo:  M304 P10.00 I0.02 D305.40  <-- Heateed Bed
   * 
   * Autotune: M303 E0 S190  C8
   * E0 = extruder hotend, S190 means ramp up to 190 degrees C, C8 means do this 8 times to get a good tuned value.
   * 
   * The results of this commands are:
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
   ...
   */
  #define  DEFAULT_bedKp 379.31
  #define  DEFAULT_bedKi 59.36
  #define  DEFAULT_bedKd 605.94
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 90 } //These are the normal Marlin Values
/**
 * ADAMS EDIT but my calibration in the Z axis kept coming up wrong. a 10mm cube comes 
 * out 8.19mm tall, so i change it:
 * You can calculate your new steps/mm like this:
 * [old steps per mm]*[nominal distance]/[measured distance] = [new steps per mm]
 * so for the Z axis: 4000*(10/8.19) = 4884
 * That gave me a cube 10.44mm, so I did the calc again: 4884 (10/10.44) = 4678. This is the value I am using.
 */ 

#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4678, 90 }
